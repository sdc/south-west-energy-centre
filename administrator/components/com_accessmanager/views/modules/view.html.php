...
class accessmanagerViewModules extends JView{
	...
	function display($tpl = null){
		...
		//toolbar			
		JToolBarHelper::apply('modules_apply');
		JToolBarHelper::save('modules_save');
		...
		//get access from db
		$helper = new accessmanagerHelper();
		$access_modules = $helper->get_access_rights('module', $this->controller->am_config['based_on']);	
		$this->assignRef('access_modules', $access_modules);
		
		//clean up rights in the table
		$helper->clean_access_table('module', 'modules', 'published');	
