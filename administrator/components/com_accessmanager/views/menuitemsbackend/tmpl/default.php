...
<form name="adminForm" method="post" action="<?php echo JRoute::_('index.php?option=com_accessmanager&view=menuitemsbackend'); ?>">	
		...
		<td>
			...
			<table class="adminlist am_table">
				<tr>		
					...
					<td>
						<input type="checkbox" name="menuitembackend_active" value="true" <?php if($this->controller->am_config['menuitembackend_active']){echo 'checked="checked"';} ?> />
					</td>
					<td>
						<?php echo JText::_('COM_ACCESSMANAGER_MENUITEM_INFO'); ?>.
						<?php echo JText::_('COM_ACCESSMANAGER_DIRECT_ACCESS_BLOCKED'); ?>.
				...
				<tr>		
					...
					<td>
						<input type="checkbox" name="menuitembackend_author_access" value="true" <?php if($this->controller->am_config['menuitembackend_author_access']){echo 'checked="checked"';} ?> />
					</td>
					<td><?php
