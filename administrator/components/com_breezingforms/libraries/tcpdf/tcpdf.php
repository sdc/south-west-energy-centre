	...
	class TCPDF {
		...
		*/
		public function setPage($pnum, $resetmargins=false) {
			$bfPage = isset($this->page) ? $this->page : 0;
			$bfNumpages = isset($this->numpages) ? $this->numpages : 0; 
			if ($pnum == $bfPage) {
				return;
			}
			if (($pnum > 0) AND ($pnum <= $bfNumpages)) {
				$this->state = 2;
		...
		*/
		public function getNumPages() {
			return isset($this->numpages) ? $this->numpages : 0;
		}
