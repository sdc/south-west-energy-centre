...
class mod_count_down_bigHelper
{
    ...
    /**
     * Load JS script for the dynamic counter
     ...
     * @return array
     */
    static function dateArray(&$params)
    {
     ...
     * @return array
     */
    static function dateformat(&$params, $ev_year, $ev_month, $ev_day, &$ev_hour)
    {
     ...
     * @return string
     */
    static function daysname($days_left, $up)
    {
        if($days_left == '1')
        {
