 ...
 * @Copyright
 *
 * @package	CountDown-Up Big
 * @author	Viktor Vogel {@link http://joomla-extensions.kubik-rubik.de/}
 * @version	2.5-4 - 2013-06-10
...
echo '<!-- CDUB - CountDown-Up Big - Kubik-Rubik Joomla! Extensions by Viktor Vogel -->';
?>
    ...
    <div class="cdub_color<?php echo $module_id; ?>">
            ...
            <?php if($up == 0) : ?>
                <span id="bigbefore<?php echo $module_id; ?>">
                    ...
                    <?php if(($ev_displaydate) OR ($ev_dhourshow) OR ($ev_text) OR ($ev_ddaysleft)) : ?>
                        <br /><br />
                    <?php endif; ?>
                    <span id="bigtime<?php echo $module_id; ?>"></span></span>
                <span id="bigafter<?php echo $module_id; ?>" class="cdub_none">
                    ...
                    <?php if($ev_displayurl_end) : ?>
                        <br /><br /><span>Link:<br /><a target="<?php echo $newwindow_end ?>" title="<?php echo $ev_urltitle_end ?>" href="<?php echo $ev_url_end ?>"><strong><?php echo $ev_urltitle_end ?></strong></a></span>
                    <?php endif; ?></span>
            <?php else : ?>
                <span id="bigafter<?php echo $module_id; ?>" class="cdub_none">
                    <?php if(($ev_displaydate OR $ev_dhourshow OR $ev_text) AND $showexpired) : ?>
        ...
        <?php else : ?>
            ...
            <?php if(($up == 0) OR ($countup AND $up == 1)) : ?>
                ...
                <?php if($ev_displayday == 0) : ?>
                    <?php if($days_left > 0) : ?>
                        <br /><br />
                        <span class="cdub_font2"><?php echo $hours_left ?> <?php echo JText::_('MOD_COUNT_DOWN_BIG_HOURSHORT'); ?> : <?php echo $minutes_left ?> <?php echo JText::_('MOD_COUNT_DOWN_BIG_MINUTESHORT'); ?> : <?php echo $seconds_left ?> <?php echo JText::_('MOD_COUNT_DOWN_BIG_SECONDSHORT'); ?> </span>
                    <?php else : ?>
                        <?php if(($ev_displaydate) OR ($ev_dhourshow) OR ($ev_text) OR ($up == 1)) : ?>
                            <br /><br />
                        <?php endif; ?>
                        <span class="cdub_font3"><?php echo $hours_left ?> <?php echo JText::_('MOD_COUNT_DOWN_BIG_HOURSHORT'); ?> : <?php echo $minutes_left ?> <?php echo JText::_('MOD_COUNT_DOWN_BIG_MINUTESHORT'); ?> : <?php echo $seconds_left ?> <?php echo JText::_('MOD_COUNT_DOWN_BIG_SECONDSHORT'); ?> </span>
                    <?php endif; ?>
                <?php endif; ?>
            <?php endif; ?>
        <?php endif; ?>
        <?php if($ev_displayurl) : ?>
            <?php if(($up == 0) OR ($up == 1 AND $ev_dlink_countup)) : ?>
                <br /><br /><span>Link:<br /><a target="<?php echo $newwindow ?>" title="<?php echo $ev_urltitle ?>" href="<?php echo $ev_url ?>"><strong><?php echo $ev_urltitle ?></strong></a></span>
            <?php endif; ?>
        <?php endif; ?>
        <?php if($poweredby == "yes") : ?>
            <br /><br /><span class="small"><a  href="http://joomla-extensions.kubik-rubik.de/" target="_blank" title="CountDown-Up Big - Kubik-Rubik Joomla! Extensions">CountDown-Up Big</a></span>
        <?php endif; ?>
    </div>
</div>